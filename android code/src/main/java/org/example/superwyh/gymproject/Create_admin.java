...
public class Create_admin extends Activity {
	...
	EditText edtID,edtPassword,edtname,edtCname;
	Button ok,no;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
			    ...
			    edtCname = (EditText)findViewById(R.id.Cname);
			    edtID = (EditText)findViewById(R.id.ID);
			    edtPassword = (EditText)findViewById(R.id.Password);
		      
			    if(edtname.getText().toString().equals("")||edtCname.getText().toString().equals("")||
			    ...
			    if(edtCname.getText().toString().equals("수원보훈요양원")||edtCname.getText().toString().equals("다솔초등학교")||edtCname.getText().toString().equals("경기대학교")
			    	||edtCname.getText().toString().equals("bohun")||edtCname.getText().toString().equals("dasol")||edtCname.getText().toString().equals("gyounggi")	)
			    {}
			    else
			    {
			    	Toast.makeText(Create_admin.this, "체육관이름을 올바르게 적어주세요.", Toast.LENGTH_SHORT).show();
			    	return;
			    ...
			    runOnUiThread(new Runnable() {
					public void run() {
						 ...
						 if(ID_result.equals("0"))
						 {
							 ...
							 try{//////////////////////////////예약 신청 / 취소
									URL url = new URL(SERVER_ADDRESS + "/admin_create_check_gym.php?"
											+ "name=" + URLEncoder.encode(name,"UTF-8")
											+ "&Cname=" + URLEncoder.encode(Cname,"UTF-8")
											+ "&ID=" + URLEncoder.encode(ID,"UTF-8")
											+ "&Password=" + URLEncoder.encode(Password,"UTF-8")
									...
									url.openStream();		
									String result = getXmlData("admin_create_check_gym.xml", "result");
									ID_result = result;
								} catch(Exception e) {
									Toast.makeText(Create_admin.this, "인터넷 연결을 확인하세요.", Toast.LENGTH_SHORT).show();
									Log.e("Error", e.getMessage());
							 ...
							 else if(ID_result.equals("1"))
							 {
								 ...
								 Toast.makeText(Create_admin.this, "해당 체육관이 이미 있습니다.", Toast.LENGTH_SHORT).show();
